...
```
 ...
 --- 
#### Lists 
Lists are different to vectors because the elements in them can be of any type. List can contain any varialbe type, vectors, matrices, functions and even lists themselves. 
